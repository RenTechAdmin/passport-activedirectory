...
import ActiveDirectory from '@jayv30/activedirectory2';
...
function Strategy(options, verify) {
  ...
  this._ad =
    options.ldap instanceof ActiveDirectory
      ? options.ldap
      : new ActiveDirectory(options.ldap);
}
